...
def CatalogoJuegos(request):
    catalogo = CatJuegos.objects.all()
    return render(request, 'CatalogoJuegos.html', {"catalogojuegos": catalogo})

def CatalogoPeliculas(request):
    catalogo = CatPeliculas.objects.all()
    return render(request, 'CatalogoPeliculas.html', {"catalogopeliculas": catalogo})

#--------------VENTAS-----------
def VentaJuegos(request):
    catalogo = VentasJuegos.objects.all()
    return render(request, 'VentaJuegos.html', {"juegosvendidos": catalogo})

def VentaPeliculas(request):
    catalogo = VentasPeliculas.objects.all()
    return render(request, 'VentaPeliculas.html', {"peliculasvendidas": catalogo})
...
def CatalogoEstrenos(request):
    catalogo = Estrenos.objects.all()
    return render(request, 'CatalogoEstrenos.html', {"catalogoestrenos": catalogo})
#-------VENTAS
