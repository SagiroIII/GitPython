...
namespace VLIGS
{
    public partial class EditarJuego : Form
    {
        ...
        void CargarDatos(int indice)
        {
            if (Tabla.Rows.Count > 0) //Si el objeto Tabla posee registros procedemos a realizar la asignación
            {
                ...
                txtIde.Text = fila["Id"].ToString();
                txtTitulo.Text = fila["Nombre"].ToString();
                txtGenero.Text = fila["Genero"].ToString();
                txtSinopsis.Text = fila["Sinopsis"].ToString();
                cboPlataforma.Text = fila["Plataforma"].ToString();
                txtFecha.Text = fila["FechaLanzamiento"].ToString();
                txtDescarga.Text = fila["Link"].ToString();
            }
            else
            {
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        // IMPORTAR IMAGEN DE SQL A PICTURE BOX
        ...
        private void EditarJuego_Load(object sender, EventArgs e)
        {
            Conectar();
        ...
        private void Modificar_Click(object sender, EventArgs e)
        {
            ...
            String sin = txtSinopsis.Text;
            String pla = cboPlataforma.Text;
            String fecha = txtFecha.Text;
            String lin = txtDescarga.Text;



            //Instrucción SQ
            Sql = "UPDATE videojuegos SET Id='" +id+"',Nombre='"+nombre+"',Genero='"+gen+"',Sinopsis='"+sin+"',Plataforma='"+pla+"',Link='"+lin+"',FechaLanzamiento='"+fecha+"'WHERE Id='"+id+"'";
            ...
            try 
            {
                ...
                MessageBox.Show("Se actualizo el juego");
